...
import example.com.sunshine.app.MainActivity;
import example.com.sunshine.app.R;
import example.com.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    static private void setLocationStatus(Context c, @locationStatus int locStatus){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        SharedPreferences.Editor spe = sp.edit();
        spe.putInt(c.getString(R.string.pref_location_status_key), locStatus);
        spe.commit();
    }
    ...
    private void notifyWeather() {
        ...
        String displayNotificationKey = context.getString(R.string.pref_notify_key);
        boolean displayNotifications = prefs.getBoolean(
                displayNotificationKey,
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    android.support.v4.app.TaskStackBuilder stackBuilder =
                            android.support.v4.app.TaskStackBuilder.create(getContext());
